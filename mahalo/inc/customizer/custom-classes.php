...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    class Mahalo_Separator extends WP_Customize_Control {

        public $type = 'mahalo-separator';
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    // Radio Image Custom Control Class.
    class Mahalo_Custom_Radio_Image_Control extends WP_Customize_Control {

        public $type = 'mahalo-radio-image';
        ...
        public function render_content() {
            ...
            <div id="input_<?php echo esc_attr($this->id); ?>" class="image mahalo-radio-image-buttenset">
 ...
 * @access public
 */
class Mahalo_Customize_Section_Upsell extends WP_Customize_Section {
...
*/
class Mahalo_Repeater_Controler extends WP_Customize_Control {
    /**
     * The control type.
     *
     * @access public
    ...
    */
    ...
    public $mahalo_box_label = '';

    public $mahalo_box_add_control = '';

    public $mahalo_box_add_button = '';
    ...
    public function __construct( $manager, $id, $args = array(), $fields = array() ) {
        $this->fields = $fields;
        $this->mahalo_box_label = $args['mahalo_box_label'] ;
        $this->mahalo_box_add_control = $args['mahalo_box_add_control'];
        $this->mahalo_box_add_button = $args['mahalo_box_add_button'];
    ...
    public function render_content() {
        ...
        <ul class="mahalo-repeater-field-control-wrap">
            <?php
            $this->mahalo_get_fields();
            ?>
        </ul>
        <input type="hidden" <?php esc_attr( $this->link() ); ?> class="mahalo-repeater-collector" value="<?php echo esc_attr( $this->value() ); ?>" />
        <?php

        if( isset( $this->mahalo_box_add_button ) && $this->mahalo_box_add_button ){ ?>
            
            <button type="button" class="button mahalo-add-control-field"><?php echo esc_html( $this->mahalo_box_add_control ); ?></button>
        <?php
        }
    ...
    private function mahalo_get_fields(){
        ...
        if( is_array( $values ) ){
            ...
            foreach($values as $value){ ?>
                ...
                <li class="mahalo-repeater-field-control">

                <div class="title-rep-wrap">
                    <span class="dashicons dashicons-move twp-filter-icon"></span>
                    <h3 class="mahalo-repeater-field-title"><?php echo esc_html( $this->mahalo_box_label ); ?></h3>
                    <span class="dashicons dashicons-arrow-down twp-filter-icon"></span>
                </div>

                <div class="mahalo-repeater-fields">
                    ...
                    foreach ($fields as $key => $field) {
                        ...
                        <div class="mahalo-fields mahalo-type-<?php echo esc_attr($field['type']).' '.esc_attr( $class ); ?>">
                            ...
                            switch ($field['type']) {
                                ...
                                case 'selector_color':
                                    ...
                                    $options = $field['options'];
                                    echo '<div class="mahalo-type-radio">';
                                ...
                                case 'upload':
                                        ...
                                        esc_html_e('No image selected', 'mahalo');
                                        echo '</div>';
                                        echo '<div class="thumbnail thumbnail-image">';
                                        echo $image;
                                        echo '</div>';
                                        echo '<div class="actions clearfix">';
                                        echo '<button type="button" class="button twp-img-delete-button align-left">'.esc_html__('Remove', 'mahalo').'</button>';
                                        echo '<button type="button" class="button twp-img-upload-button alignright">'.esc_html__('Select Image', 'mahalo').'</button>';
                    ...
                    <div class="clearfix mahalo-repeater-footer">
                        <div class="alignright">
                        <?php if( isset( $this->mahalo_box_add_button ) && $this->mahalo_box_add_button ){ ?>
                            <a class="mahalo-repeater-field-remove" href="#remove"><?php esc_html_e('Delete', 'mahalo') ?>|</a> 
                        <?php } ?>
                        <a class="mahalo-repeater-field-close" href="#close"><?php esc_html_e('Close', 'mahalo') ?></a>
                        </div>
                    </div>
                </div>
                </li>
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    // Repeator Info
    class Mahalo_Info_Notiece_Control extends WP_Customize_Control {
            ...
            <span class="customize-control-title">
                ...
                <div class="twp-info-icon">
                    <div class="icon-notice-wrap">
                        <span class="dashicons dashicons-move twp-filter-icon"></span>
                        <p><?php esc_html_e( 'Click hold and drag to re-order.', 'mahalo' ); ?></p>
                    </div>
                    <div class="icon-notice-wrap">
                        <span class="dashicons dashicons-arrow-down twp-filter-icon"></span>
                        <p><?php esc_html_e( 'Click to expand settings.', 'mahalo' ); ?></p>
                    </div>
                </div>
            </span>
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    // Repeator Info
    class Mahalo_Premium_Notiece_Control extends WP_Customize_Control {
            ...
            <span class="customize-control-title">
                <div class="theme-info-icon">
                    <div class="icon-notice-wrap">
                        ...
                        <span><?php echo esc_html__('More ','mahalo'). esc_html( $this->label ). esc_html__(' Available on Premium Version.', 'mahalo' ); ?></span>
                    </div>
                </div>
            </span>
...
if ( ! function_exists( 'mahalo_sanitize_number_range' ) ) :
     ...
     */
    function mahalo_sanitize_number_range( $input, $setting ) {
