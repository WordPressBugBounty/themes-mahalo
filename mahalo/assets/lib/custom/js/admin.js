(function ($) {
    ...
    var ajaxurl = mahalo_admin.ajax_url;
    var mahaloNonce = mahalo_admin.ajax_nonce;
    var custom_theme_file_frame;

    // Category Color
    $('#mahalo-cat-color').wpColorPicker();
    ...
    $('.twp-img-upload-button').click(function () {
        ...
        frame = wp.media({
            title: mahalo_admin.upload_image,
            button: {
                text: mahalo_admin.use_image
            },
    ...
    $('.twp-custom-setup').click(function () {
        ...
        var data = {
            'action': 'mahalo_notice_dismiss',
            '_wpnonce': mahaloNonce,
        };

        $.post(ajaxurl, data, function (response) {

            $('.twp-mahalo-notice').hide();
    ...
    $('.twp-install-active').click(function () {
        ...
        $(this).closest('.twp-mahalo-notice').addClass('twp-installing');

        var data = {
            'action': 'mahalo_install_plugins',
            '_wpnonce': mahaloNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function () {
        ...
        $.post(ajaxurl, data, function (response) {
            ...
            var active = mahalo_admin.active
            var deactivate = mahalo_admin.deactivate
